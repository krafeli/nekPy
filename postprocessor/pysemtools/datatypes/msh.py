...
class Mesh:
    ...
    def get_vertices(self):
        ...
        if self.gdim == 2:
            self.vertices = np.zeros((self.nelv, 4, 3), dtype=self.x.dtype) # 4 vertices, 3 coords.txt (z = 0)
            ...
            self.vertices = np.zeros((self.nelv, 8, 3), dtype=self.x.dtype) # 4 vertices, 3 coords.txt
    ...
    def get_edge_centers(self):
        ...
        if self.gdim == 2:
            self.edge_centers = np.zeros((self.nelv, 4, 3), dtype=self.x.dtype) # 4 vertices, 3 coords.txt (z = 0)
            ...
            self.edge_centers = np.zeros((self.nelv, 12, 3), dtype=self.x.dtype) # 4 vertices, 3 coords.txt
